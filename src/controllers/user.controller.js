...
const registerUser = asyncHandler(async (req, res) => {
  ...
  // check if the user exist already with multiple values
...
const loginUser = asyncHandler(async (req, res) => {
  ...
  // if we want just one either email or username
  // if(!(username || email)){
  //   throw new ApiError(400, "username or email is required")
  // }
  ...
  // this will ensure that cookies will be modified only in server
  const options = {
    httpOnly: true,
    secure: true,
  };
